...
<html lang="en" dir="ltr">
   ...
   <body style="background-image: url('images/background.png') ;">  
      ...
      ?>
        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#ModalToggleNsupply">
                ציוד חדש
        </button>
        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#ModalToggleUsupply">
            לעדכן ציוד 
        </button>
         <div class="row my-3 align-items-center justify-content-center">
            ...
            <div class="watermark my-3 ">מועדון כדורמים קרית טבעון   <img src="images/TivonLogo.PNG" height="50" width="100" >
               ...
               <div class="card">
                  ...
                  <h5 class="card-title text-center fw-bolder fs-3" dir ="rtl">כמות הציוד:</h5>
