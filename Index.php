...
<html lang="en" dir="ltr">
   ...
   <header class="bg-danger">
            <div class="row justify-content-center ">
               ...
               <div class="col-1 pb-3 me-5 my-2 text-center ">
                  <a href="index.html">
                  <img src="images/סמל קריית טבעון בכדור מים.png" alt="tivon logo" style="width: 140%; height: 120%;" >
               </a>   
               </div>
   ...
   <body style="background-image: url('images/bg1.jpeg') ;">
    <nav>
        ...
        <ul>
            <li><a href="schedule.html">מערכת שעות</a></li>
            <li><a href="memorialization.html">הנצחה</a></li>
            <li><a href="legasy.html">מורשת</a></li>
            <li><a href="gallery.html">גלריה</a></li>
            <li><a href="update.html">עידכונים</a></li>
            <li><a href="player.html">שחקנים</a></li>
            <li><a href="team.html">קבוצות</a></li>
        </ul>
    </nav>
