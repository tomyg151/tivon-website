               ...
               <div class="col-3">
                  <div class="card my-3 border-primary border-2" style="background-color:rgba(255,7,7,0.5);">
                     <div class="card-body text-center py-4">
                        ...
                        <form method="POST">
                           <button class="btn btn-outline-warning my-2" value="<?php echo $rows['tId'];?>" name="deleteTeam">מחק</button>
                           <button class="btn btn-outline-info my-2" value="<?php echo $rows['tId'];?>" name="teamId" onclick="window.location.href='#namesTable'">הצג</button>
                        <?php } ?>
                     </div>
                  </div>
               </div>
